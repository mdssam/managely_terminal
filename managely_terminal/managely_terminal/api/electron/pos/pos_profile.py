...
def get_pos_details():
	...
	details = {
		...
		"custom_allow_returns": getattr(pos, "custom_allow_returns", 1),
...
def set_pos_profile_defaults(doc, method=None):
	"""Always enforce Managely Thermal Standard EN/AR templates on all POS Profiles."""
	doc.custom_pos_print_format_en = "Managely Thermal Standard EN"
	doc.custom_pos_print_format_ar = "Managely Thermal Standard AR"
	doc.print_format = "Managely Thermal Standard EN"
